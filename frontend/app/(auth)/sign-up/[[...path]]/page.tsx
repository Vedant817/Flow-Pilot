  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 w-screen">
      <div className="flex min-h-screen w-full">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-8 bg-white/30 backdrop-blur-sm lg:border-l border-slate-200/50">
            ...
            <SignUp 
              appearance={{
                elements: {
                  ...
                  phoneInputBox: 'block w-full px-4 py-3 rounded-lg bg-slate-50 border-2 border-slate-200 text-slate-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all',
                  otpCodeFieldInput: 'block w-full px-4 py-3 rounded-lg bg-slate-50 border-2 border-slate-200 text-slate-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-center',
